namespace PgBrew
{
    ...
    public class Alcoholx4x3x4x3Line : INotifyPropertyChanged
    {
        public Alcoholx4x3x4x3Line(Alcoholx4x3x4x3 owner, int index1, int index2, int index3, int index4, int effectIndex)
        {
            Owner = owner;
            Index1 = index1;
            Index2 = index2;
        ...
        public Alcoholx4x3x4x3 Owner { get; }
