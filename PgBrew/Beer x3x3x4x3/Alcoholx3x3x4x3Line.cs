namespace PgBrew
{
    ...
    public class Alcoholx3x3x4x3Line : AlcoholLine, INotifyPropertyChanged
    {
        ...
        public string Component4 { get { return ((Alcoholx3x3x4x3)Owner).ComponentList3[Index4].Name; } }
    }
}
