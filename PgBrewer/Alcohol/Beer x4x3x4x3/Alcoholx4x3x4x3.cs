...
public class Alcoholx4x3x4x3 : Alcohol, IFourComponentsAlcohol
{
    public static async Task<Alcoholx4x3x4x3> Create(Settings settings, string name, List<Component> componentList1, List<Component> componentList2, List<Component> componentList3, List<Component> componentList4)
    {
        ...
        Alcoholx4x3x4x3 Instance = new(name, componentList1, componentList2, componentList3, componentList4);
        await Instance.Init(settings);

        return Instance;
    }

    private Alcoholx4x3x4x3(string name, List<Component> componentList1, List<Component> componentList2, List<Component> componentList3, List<Component> componentList4)
        : base(name)
    {
